...
DropdownButtonFormField<String>(
  ...
  items: <String>['Canino', 'Felino', 'Roedor', 'Ave']
...
void _saveRecord() {
  // Crie o registro usando a categoria selecionada
  final newRecord = Record(category: _selectedCategory, ...);

  // Salve o registro no banco de dados
  DatabaseHelper.instance.insertRecord(newRecord);
}
